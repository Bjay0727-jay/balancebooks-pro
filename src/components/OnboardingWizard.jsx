        ...
        <div className="p-6">
          ...
          {step === 0 && (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold bg-gradient-to-r from-[#1e3a5f] to-[#14b8a6] bg-clip-text text-transparent">Welcome to BalanceBooks Pro</h2>
          ...
          {step === 1 && (
            <div className="space-y-4">
              <div className="text-center">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#14b8a6]/20 to-blue-100 flex items-center justify-center mx-auto mb-3">
                  <DollarSign size={28} className="text-[#14b8a6]" />
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {topBudgetCats.map(cat => (
                  <button key={cat.id} onClick={() => setSelectedBudgetCat(cat.id)} className={`flex flex-col items-center p-2 rounded-xl border-2 transition-all ${selectedBudgetCat === cat.id ? 'border-[#14b8a6] bg-[#14b8a6]/5' : 'border-slate-200 hover:border-slate-300'}`}>
