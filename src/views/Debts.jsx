              ...
              <div key={d.id} className="border border-slate-200 rounded-xl p-4 hover:border-rose-300 transition-all">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button onClick={() => setEditDebt(d)} className="p-2 text-[#14b8a6] hover:bg-blue-50 rounded-lg"><Edit2 size={16} /></button>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div><p className="text-slate-500">Min Payment</p><p className="font-bold text-[#14b8a6]">{currency(d.minPayment)}/mo</p></div>
                </div>
              </div>
            ))}
          </div>
